...
export default function AddTopicHome() {
  ...
  let newTopicId;
  if (items) {
    numberOfTopics = Object.keys(items).length;
  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="w-full h-full bg-gradient-to-b from-cyan-500 to-slate-700 pt-8">
        ...
        <div className="rounded-md shadow-lg w-3/4 h-68 lg:h-96 lg:h-2/4 bg-slate-200 m-auto p-4 lg:p-8 flex-col z-50">
          <div className="flex">
            <div className="flex flex-col gap-1 w-1/4">
              <img src={photo} className="rounded-full size-10 lg:size-20" />
